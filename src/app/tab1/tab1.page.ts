...
export class Tab1Page implements OnInit {
  ...
  selectedCategories = ['Clothing', 'Shoes', 'Books'];
  ...
  slides = [
    {
      id: 1,
      imgUrl:
        'https://inews.co.uk/images-i.jpimedia.uk/imagefetch/https://inews.co.uk/wp-content/uploads/2019/07/best-clothes-subscription-boxes.png?width=640',
    },
    {
      id: 2,
      imgUrl:
